...
int main() {
    std::cout << "Loading nos5.mtx matrix..." << std::endl;
    ...
    try {
        ...
        auto result = linear_algebra::conjugateGradient(A, b, x, x_true, 1000, 1e-17);
        
        // MATLAB形式での結果出力
        linear_algebra::print_num_results(result, "nos5.mtx");
